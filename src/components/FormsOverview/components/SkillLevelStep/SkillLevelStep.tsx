          ...
          <div className=" mt-6 grid gap-4 grid-cols-1 md:grid-cols-2 grid-rows-2">
            <label
              className={classNames(
                ...
                { "border-orange": watch("skillLevel") == Level.Beginner }
              )}
            >
              <input
                {...register("skillLevel")}
            ...
            <label
              className={classNames(
                "border-[1px] border-gray-light rounded-md p-4 flex flex-row items-center gap-4 hover:cursor-pointer hover:border-orange",
                {
                  "border-orange": watch("skillLevel") == Level.Intermediate,
                }
              )}
            >
              <input
            ...
            <label
              className={classNames(
                "border-[1px] border-gray-light rounded-md p-4 flex flex-row items-center gap-4 hover:cursor-pointer hover:border-orange",
                { "border-orange": watch("skillLevel") == Level.Advanced }
              )}
            >
              <input
                {...register("skillLevel")}
            ...
            <label
              className={classNames(
                "border-[1px] border-gray-light rounded-md p-4 flex flex-row items-center gap-4 hover:cursor-pointer hover:border-orange",
                { "border-orange": watch("skillLevel") == Level.Expert }
              )}
            >
              <input
                {...register("skillLevel")}
